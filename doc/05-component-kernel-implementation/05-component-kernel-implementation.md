...
I chose a Map as this makes the most sense in this scenario. This is as there is
going to be one unique account name with values for that associated account.
A Map needs a unique key associated with a value to function, therefore Map is
