...
I will choose the design of the bank account due to the DNASequence being a
data structure wrapper and the stock portfolio needing a API key and a paid
subscription to be able to collect data about stock prices. The bank account can
many different functions that will relate to modern banking and functions and
allows a lot of functionality when it comes to desinging it. From having multiple
different acccounts, calculating interest, being able to transfer money from
one account to another, removing and adding money, and deleting accounts. This
component will be versatile for many functions and cases.
